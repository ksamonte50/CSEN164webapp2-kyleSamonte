...
class AdminusersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create adminuser" do
    assert_difference("Adminuser.count") do
      post adminusers_url, params: { adminuser: { name: @adminuser.name, password_digest: @adminuser.password_digest } }
    end
  ...
  test "should update adminuser" do
    patch adminuser_url(@adminuser), params: { adminuser: { name: @adminuser.name, password_digest: @adminuser.password_digest } }
